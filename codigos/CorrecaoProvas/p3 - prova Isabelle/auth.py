...
class PasswordLower(AuthException):
    pass

class PasswordUpper(AuthException):
    pass
...
class Authenticator:
    ...
    def add_user(self, username, password):
        ...
        if len(password).islower():
            raise PasswordLower(username)
        if len(password).isupper():
            raise PasswordUpper(username)
