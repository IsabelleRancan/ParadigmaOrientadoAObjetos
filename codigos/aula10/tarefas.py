#operadores que não existem em PY e seus substitutos:
# ! = not; && = and; ||= or 
...
class Tarefa:
    #os parametros obrigatórios estão sem igual e os opcionais com igual
    ...
    def contem(self, conteudo):
        #vai verificar se o conteúdo está contido no título
...
class Lista:
    def __init__(self):
        #nesse caso o único atributo da lista é tarefas
        self.tarefas = []
    ...
    def obter_tarefas(self, filtro=None, apenas_nao_concluidas=False):
        ...
        #criando uma nova lista para adicionar as tarefas que não foram concluídas
        tarefas=[]

        #esse novo vetor vai receber todos os itens da lista antiga que não possuem o "tarefa concluida"
        # usando list comprehension
